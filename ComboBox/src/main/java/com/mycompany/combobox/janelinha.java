...
public class janelinha extends javax.swing.JFrame {
    ...
    public janelinha() {
        initComponents();
        String [] combo = {"Etanol", "Gasolina"};
        jComboBox1.removeAllItems();
        
        DefaultComboBoxModel<String> model = new DefaultComboBoxModel(combo);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       // JOptionPane.showMessageDialog(rootPane, jComboBox1.getSelectedItem());
        ...
        if (jComboBox1.getSelectedItem() .equals("Etanol")) {
          // JOptionPane.showMessageDialog(rootPane,"O preço do Etanol é R$2,13");
          resultado r = new resultado(jComboBox1.getSelectedItem().toString());
          r.setVisible(true);
        } else {
          //  JOptionPane.showMessageDialog(rootPane, "O preço da Gasolina é R$3,10");
          resultado r = new resultado(jComboBox1.getSelectedItem().toString());
          r.setVisible(true);
        }
